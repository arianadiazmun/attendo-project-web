  ...
  <div className="container max-w-3xl px-4 mx-auto sm:px-8">
    <div className="py-8">
      <div className="flex flex-row justify-between w-full mb-1 sm:mb-0">
        ...
        <Dropdown>
    <Dropdown.Button flat>Filter by grade</Dropdown.Button>
    <Dropdown.Menu aria-label="Static Actions">
      <Dropdown.Item key="9th">9th</Dropdown.Item>
      <Dropdown.Item key="10th">10th</Dropdown.Item>
      <Dropdown.Item key="11th">11th</Dropdown.Item>
          ...
          <table className="min-w-full leading-normal">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="px-5 py-3 text-sm font-normal text-left text-gray-800 uppercase bg-white border-b border-gray-200">Full Name</th>
                <th
                  scope="col"
              ...
              <tr>
                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                  <div className="flex items-center">
                    ...
                    <div className="ml-3">
                      <p className="text-gray-900 whitespace-no-wrap"></p>{user.name || user.full_name}
                    </div>
                  </div>
                </td>
                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                ...
                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                  <p className="text-gray-900 whitespace-no-wrap">{user.grade}<sup>th</sup> </p>
                </td>
                <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
